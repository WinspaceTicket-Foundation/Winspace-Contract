...
contract WinSpaceTicketToken is Context, IERC20, Ownable, SafeToken {
    // User data Lottery
    struct userData {
        address userAddress;
        uint256 totalWon;
    ...
    address payable public marketingAddress =
        payable(0x725Ee13Cc8c655bD7e2C87Bf14dc565d0622Cf42); // Marketing Address
    ...
    string private _name = "WinSpaceTicket Token";
    string private _symbol = "TheMoon";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _potFee = 8;
    ...
    uint256 public winAmount = 388000000000000000000;
